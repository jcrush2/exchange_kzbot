...
@bot.message_handler(commands=["brus"])
def donate(msg):
	markup = telebot.types.InlineKeyboardMarkup()
	button = telebot.types.InlineKeyboardButton(text='🍒 Заказать', url="https://t.me/dar_lesa_bot")
	markup.add(button)
	
	bot.edit_message_caption(
	chat_id=-1001460790619,
	message_id=4,
	caption="ℹ️ Брусника свежая с доставкой в Хабаровске.\n\nБрусника и ягода в наличии.\n\nЦена 350р литр.\n\nДоставка от 5 л бесплатно\n\nтел. +79242104451️", parse_mode="HTML", reply_markup=markup)
	return
